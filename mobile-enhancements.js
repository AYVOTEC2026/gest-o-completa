(function(){
  const loadOrangeWhiteTheme=()=>{
    ...
    visual.src='orange-white-theme.js?v=20260925f';
  ...
  const loadParkOperations=()=>{
    ...
    ops.src='park-operations.js?v=20260925f';
  ...
  const loadCommercialSuite=()=>{
    ...
    theme.src='commercial-theme.js?v=20260925f';
    theme.onload=()=>{
      const polish=document.createElement('script');
      polish.src='commercial-polish.js?v=20260925f';
  ...
  core.src='mobile-enhancements-core.js?v=20260925f';
  core.onload=()=>{
    const fix=document.createElement('script');
    fix.src='nav-hotfix.js?v=20260925f';
